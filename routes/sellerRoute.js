...
const { createSeller, deleteSeller, updateSeller, getAllMessages, checkSellerDetails, getActiveProperty } = require("../controllers/sellerController")
...
router.route("/getProperty").post(getActiveProperty)
